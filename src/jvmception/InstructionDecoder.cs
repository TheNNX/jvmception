...
(IUnitSerializable p1, IUnitSerializable p2) =>
{
...
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMFloat(((JVMFloat)p1).floatValue() - ((JVMFloat)p2).floatValue());
        ...
        /* dsub */
        instructionTable[0x67] = new InstructionXYtoZ(new JVMDouble(), new JVMDouble(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
...
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMLong(((JVMLong)p1).longValue() * ((JVMLong)p2).longValue());
        ...
        /* fmul */
        instructionTable[0x6A] = new InstructionXYtoZ(new JVMFloat(), new JVMFloat(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMFloat(((JVMFloat)p1).floatValue() * ((JVMFloat)p2).floatValue());
        ...
        /* dmul */
        instructionTable[0x6B] = new InstructionXYtoZ(new JVMDouble(), new JVMDouble(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
...
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMLong(((JVMLong)p1).longValue() / ((JVMLong)p2).longValue());
        ...
        /* fdiv */
        instructionTable[0x6E] = new InstructionXYtoZ(new JVMFloat(), new JVMFloat(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMFloat(((JVMFloat)p1).floatValue() / ((JVMFloat)p2).floatValue());
        ...
        /* ddiv */
        instructionTable[0x6F] = new InstructionXYtoZ(new JVMDouble(), new JVMDouble(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMDouble(((JVMDouble)p1).doubleValue() / ((JVMDouble)p2).doubleValue());
        ...
        /* irem */
        instructionTable[0x70] = new InstructionXYtoZ(new JVMInteger(), new JVMInteger(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMInteger(((JVMInteger)p1).intValue() % ((JVMInteger)p2).intValue());
        ...
        /* lrem */
        instructionTable[0x71] = new InstructionXYtoZ(new JVMLong(), new JVMLong(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMLong(((JVMLong)p1).longValue() % ((JVMLong)p2).longValue());
        ...
        /* frem */
        instructionTable[0x72] = new InstructionXYtoZ(new JVMFloat(), new JVMFloat(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMFloat(((JVMFloat)p1).floatValue() % ((JVMFloat)p2).floatValue());
        ...
        /* drem */
        instructionTable[0x73] = new InstructionXYtoZ(new JVMDouble(), new JVMDouble(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
...
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMLong(((JVMLong)p1).longValue() << (int)((JVMLong)p2).longValue());
...
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMLong(((JVMLong)p1).longValue() >> (int)((JVMLong)p2).longValue());
        ...
        /* iushr */
        instructionTable[0x7C] = new InstructionXYtoZ(new JVMInteger(), new JVMInteger(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
...
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMLong(((JVMLong)p1).longValue() & ((JVMLong)p2).longValue());
        ...
        /* ior */
        instructionTable[0x80] = new InstructionXYtoZ(new JVMInteger(), new JVMInteger(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
...
(IUnitSerializable p1, IUnitSerializable p2) =>
{
    ...
    return new JVMLong(((JVMLong)p1).longValue() | ((JVMLong)p2).longValue());
        ...
        /* ixor */
        instructionTable[0x82] = new InstructionXYtoZ(new JVMInteger(), new JVMInteger(),
(IUnitSerializable p1, IUnitSerializable p2) =>
{
...
(CallFrame frame) =>
{
    ...
    frame.setLocal(index, i);
        ...
        /* lcmp */
        instructionTable[0x94] = new Instruction((CallFrame frame) =>
            {
        ...
        /* ifeq */
        instructionTable[0x99] = new InstructionConditional((int i) =>
{
    ...
    return i == 0;
        ...
        /* ifne */
        instructionTable[0x9A] = new InstructionConditional((int i) =>
{
    ...
    return i != 0;
        ...
        /* iflt */
        instructionTable[0x9B] = new InstructionConditional((int i) =>
{
    ...
    return i < 0;
        ...
        /* ifge */
        instructionTable[0x9C] = new InstructionConditional((int i) =>
{
    ...
    return i >= 0;
        ...
        /* iflt */
        instructionTable[0x9D] = new InstructionConditional((int i) =>
{
    ...
    return i > 0;
        ...
        /* ifge */
        instructionTable[0x9E] = new InstructionConditional((int i) =>
{
    ...
    return i <= 0;
        ...
        /* if_icmpeq */
        instructionTable[0x9F] = new InstructionConditional2((int i) =>
{
    ...
    return i == 0;
        ...
        /* if_icmpne */
        instructionTable[0xA0] = new InstructionConditional2((int i) =>
{
    ...
    return i != 0;
        ...
        /* if_icmplt */
        instructionTable[0xA1] = new InstructionConditional2((int i) =>
{
    ...
    return i < 0;
        ...
        /* if_icmpge */
        instructionTable[0xA2] = new InstructionConditional2((int i) =>
{
    ...
    return i >= 0;
        ...
        /* if_icmpgt */
        instructionTable[0xA3] = new InstructionConditional2((int i) =>
{
    ...
    return i > 0;
        ...
        /* if_icmple */
        instructionTable[0xA4] = new InstructionConditional2((int i) =>
{
    ...
    return i <= 0;
        ...
        /* jsr */
        instructionTable[0xA8] = new InstructionJsr();
...
(CallFrame frame) =>
{
    ...
    public void execute(CallFrame f)
    {
        int instructionByte = f.getNextByte() & 0xFF;
        //System.Console.Write(f.getString() + ": " + instructionByte + " ");
        //System.Console.WriteLine(instructionTable[instructionByte].GetType().Name);
